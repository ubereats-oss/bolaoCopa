...
import '../../features/admin/manage_results_screen.dart';
...
// matches, extras e ranking são abertas via Navigator.push a partir
// de GroupHomeScreen, recebendo groupId como parâmetro.
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> get routes => {
        ...
        adminResults: (_) => const ManageResultsScreen(),
